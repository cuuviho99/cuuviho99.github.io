...
var app = {
    ...
    songsStock:[
		...
		path: "./assets/music/esraxled.mp3",
		image: "./assets/img/def.jpg"
	},{
    	id: 129,
		author: "B Ray",
		name: "Ex's Hate Me",
		path: "./assets/music/ex.mp3",
		image: "./assets/img/def.jpg"
	},{
    	id: 130,
		author: "Sơn Tùng MTP",
		...
		author: "Chipu",
		name: "Anh Ơi Ở Lại",
		path: "./assets/music/AnhOiOLai.mp3",
		image: "./assets/img/def.jpg"
	},{
    	id: 133,
		author: "Đạt G",
		name: "Khó vẽ nụ cười",
		path: "./assets/music/KhoVeNuCuoi.mp3",
		image: "./assets/img/def.jpg"
	},{
    	id: 134,
		author: "Dig Didzay",
		...
		path: "./assets/music/AnhTaBoEmRoi.mp3",
		image: "./assets/img/def.jpg"
	},{
    	id: 136,
		...
		path: "./assets/music/CFDangVaMua.mp3",
		image: "./assets/img/def.jpg"
	},{
    	id: 138,
		author: "Minh Vương",
		name: "Đừng làm anh đau",
		path: "./assets/music/DungLamAnhDau.mp3",
		image: "./assets/img/def.jpg"
	},{
    	id: 139,
		author: "Thanh Goll",
		name: "Cánh Chim Hải Âu (Acoustic Cover)",
		path: "./assets/music/CanhChimHaiAu.mp3",
		image: "./assets/img/def.jpg"
	},{
    	id: 140,
		author: "Minh Vương",
		...
		path: "./assets/music/DemTrangTinhYeu.mp3",
		image: "./assets/img/def.jpg"
	},{
    	id: 143,
		author: "Hoàng Yến Chibi",
		name: "Ngồi Bên Em",
		path: "./assets/music/NgoiBenEm.mp3",
		image: "./assets/img/def.jpg"
	},{
    	id: 144,
		author: "B Ray",
		...
		path: "./assets/music/MatTraiCuaSuThat.mp3",
		image: "./assets/img/def.jpg"
	},{
    	id: 146,
		author: "Thương Võ",
		name: "Còn gì đau hơn chữ đã từng (Cover)",
		path: "./assets/music/ConGiDauHonChuDaTung.mp3",
		image: "./assets/img/def.jpg"
	},{
    	id: 147,
		author: "Đinh Tùng Huy",
		name: "Cứ Ngỡ Là Anh",
		path: "./assets/music/CuNgoLaAnh.mp3",
		image: "./assets/img/def.jpg"
	},{
    	id: 148,
		author: "Quang Vinh, Bảo Thy ",
		name: "Ngôi Nhà Hoa Hồng",
		path: "./assets/music/NgoiNhaHoaHong.mp3",
		image: "./assets/img/def.jpg"
	},{
    	id: 149,
		author: "Thanh Hưng",
		...
		path: "./assets/music/TinhYeuMangTheo.mp3",
		image: "./assets/img/def.jpg"
	},{
    	id: 152,
		author: "Hương Tràm",
		name: "Duyên Mình Lỡ",
		path: "./assets/music/DuyenMinhLo.mp3",
		image: "./assets/img/def.jpg"
	},{
    	id: 153,
		author: "Đức Phúc",
    	...
    	id: 156,
		author: "Khánh Ngọc, Nhật Tinh Anh ",
		name: "Vầng Trăng Khóc",
		path: "./assets/music/VangTrangKhoc.mp3",
		image: "./assets/img/def.jpg"
	},{
    	id: 157,
